window.RECURSOS_VIDEOS = [
  {
    id: 'ansiedad-al-hablar',
    audience: 'personas',
    category: 'abordaje',
  ...
  {
    id: 'burlas-tartamudez',
    audience: 'personas',
    category: 'abordaje',
    categories: ['abordaje'],
    title: '¿Cómo responder a las burlas de tartamudez?',
    use: 'secundario',
    youtubeUrl: '',
    youtubeId: '',
    status: 'pendiente',
